...
- [Estructura del directorio](#estructura-del-directorio)
   - [Ejercicios sobre actions](actions/)
   - [Ejercicios sobre contextos](context/)
   - [Ejercicios sobre jobs](jobs/)
   - [Ejercicios con workflows reutilizables](reusable/)
   - [Ejercicios sobre triggers](triggers/)
   - [Ejercicios sobre variables](variables/)
- [Requisitos para ejecutar los workflows](#requisitos-para-ejecutar-los-workflows)
...
├── actions/                # Ejercicios sobre actions
│   ├── README.md
│   └── *.yml o scripts
